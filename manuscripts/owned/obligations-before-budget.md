...
**What the pilot leaves out.** The pilot carries no transition budget. Migrating existing configurations and running the old and new processes side by side belong to a second stage and would be priced there, as the funding example in [Match the Funding to the Work](#raise-what-you-need) prices them.
...
**Scenario note.** The pilot’s cost basis and decision rules are shared with [Match the Funding to the Work](#raise-what-you-need) and the day-100 ledger of Part V, and the onboarding constraint is supported by customer evidence, as in [The Chain From Roadmap to Revenue Breaks Easily](#roadmap-to-revenue). The maintenance timing deliberately differs: those chapters place the first year of maintenance in the financial year after the step ships; here the charge starts the month the step enters service.
