...
**Organic growth** means development within an existing business under a stated comparison, not revenue added by buying another business. A larger consolidated revenue number doesn’t establish it. The TeamSystem case shows how acquisition dates and constructed full-year comparisons can change the apparent growth rate: the chapter [TeamSystem: Each New Owner Inherits Progress and Unfinished Work](#teamsystem). A combined product catalogue isn’t necessarily a more useful customer proposition, and a lower group cost ratio isn’t evidence that every acquired business improved.

Write the thesis in terms of what customers or the company will do differently. If the thesis is cross-selling, identify overlapping customer needs and a practical way for the sales team to offer and support the additional products. If it’s product integration, identify the shared workflow and data boundaries. If it’s cost reduction, identify the actual assets, contracts and roles that can change. Where the roles are people, the saving arrives after notice periods and severance, and only once the receiving team has passed the knowledge-transfer test in the chapter [Trace the Work: Headcount Is Not Capacity](#fix-decisions-before-hiring); the chapter [Manage Funding Delays: Revise the Cash Plan and Commitments](#anatomy-of-a-layoff) reconciles a staffing reduction by date and shows what a consolidation after an acquisition has to check before the synergy date is fixed.
...
![Separate operations, shared services and a combined product represent different integration choices.](private-techuity/posts/17-acquisition-adds-work-first/assets/images/17-acquisition-adds-work-first/integration-depth-by-benefit.jpeg)
...
![A separated business must replace shared services or make explicit arrangements to keep using them.](private-techuity/posts/17-acquisition-adds-work-first/assets/images/17-acquisition-adds-work-first/carveout-hidden-dependencies.jpeg)
