...
# 13. Headcount Is Not Capacity: Trace the Work Before You Hire
...
The chapter [Decide Who Decides, Before You Disagree](#decide-who-decides) separates the three; the chapter [Find the Help That Changes What Your Team Can Do](#help-that-changes-capability) covers what investor recruiting support can and cannot supply.
...
| If the role had been outside the plan | It would have been the board’s decision whatever cash the operating budget held, because available cash does not establish hiring authority (see the chapter [Decide Who Decides, Before You Disagree](#decide-who-decides)) |
...
The opposite movement, a plan that has to shrink rather than grow, has its own chapter: [Anatomy of a Layoff](#anatomy-of-a-layoff) follows a reduction from the investor’s request to the people it affects.
