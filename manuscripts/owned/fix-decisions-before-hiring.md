...
The opposite movement, a plan that has to shrink rather than grow, has its own chapter: [Manage Funding Delays: Revise the Cash Plan and Commitments](#anatomy-of-a-layoff) follows a reduction from the investor’s request to the people it affects.
