...
Back to the onboarding proposal. The board answered within the two weeks. It did not approve the €1 million program in one year. It endorsed the direction and confirmed the first stage Ines had already approved within her delegation in [Confirm the Cash Before You Commit](#obligations-before-budget): the reusable setup step as a pilot, €180,000 for the build plus €30,000 of first-year maintenance, €210,000 from the year’s residual and opening cash, and twelve engineer-weeks of the current team. It kept the two implementation hires as its own decision, because permanent hires outside the approved headcount plan are the board’s whatever they cost.
