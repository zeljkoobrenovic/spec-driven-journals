...
![Decide Who Decides, Before You Disagree — logo](private-techuity/posts/06-decide-who-decides/assets/images/06-decide-who-decides/logo.jpeg)
...
This is the €1 million program discussed in the chapter [Confirm the Cash Before You Commit](#obligations-before-budget), not an approved commitment to spend it. The board still needs a feasible funding plan, and the chapter [You Cannot Fund Every Good Project at Once](#cannot-fund-everything) shows why it may fund a smaller step first.
...
The chapter [Headcount Is Not Capacity: Trace the Work Before You Hire](#fix-decisions-before-hiring) works an investor-proposed appointment through that distinction, and [Anatomy of a Layoff](#anatomy-of-a-layoff) a staffing reduction, where all three arrive at the same board meeting.
