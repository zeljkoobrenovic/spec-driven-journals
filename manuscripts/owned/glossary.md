...
- **G** — [General partner](#glossary--organizations) · [Generalizability](#glossary--evidence) · [Generative AI](#glossary--technology) · [Go-live](#glossary--technology) · [Good leaver](#glossary--transactions) · [Governance](#glossary--roles) · [GP](#glossary--organizations) · [Grounded Architecture](#glossary--technology) · [Gross return](#glossary--returns) · [Gross revenue retention](#glossary--earnings) · [Growth equity](#glossary--arrangements)
...
For application, read the chapter [Success for Whom, and for How Long?](#success-for-whom) or use [Practical Tools for Ownership and Technology Decisions](#toolkit); the chapter [Use Diligence: Correct the Plan Before It Is Signed](#diligence-corrects-the-plan) shows the observed / reported / inferred split in use, and the chapter [Build the Evidence Everyone Trusts: Data Foundations for Alignment](#data-foundations-for-alignment) covers defining, owning and labelling the figures a company reports.
...
| Actual / target / forecast / assumption | An observed and recorded result / what was committed to / a calculation about the future from stated inputs / an input taken as given that may not hold. The chapter [Build the Evidence Everyone Trusts: Data Foundations for Alignment](#data-foundations-for-alignment) asks that every reported figure carry which of the four it is. |
