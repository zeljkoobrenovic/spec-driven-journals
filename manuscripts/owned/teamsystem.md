{id: teamsystem}
# 34. TeamSystem: Each New Owner Inherits Progress and Unfinished Work

![TeamSystem: Each New Owner Inherits Progress and Unfinished Work — logo](private-techuity/posts/31-teamsystem/assets/images/29-teamsystem/logo.jpeg)
...
What happened to the retained interest later illustrates the same distinction, and each later document answers a different question. The table gives the sequence once; the paragraph after it explains why the figures cannot be chained together.
...
![A partial exit generates cash for the sold stake while the retained stake continues to carry an estimated value.](private-techuity/posts/31-teamsystem/assets/images/29-teamsystem/partial-exit-cash-and-retained-value.jpeg)
...
![The company carries products, customers, integration work and obligations through successive changes of owner.](private-techuity/posts/31-teamsystem/assets/images/29-teamsystem/company-history-across-successive-owners.jpeg)
