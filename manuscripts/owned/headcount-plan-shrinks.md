...
It is 1 October at fictional Larkspur, and the board review that [The Roadmap Did Not Slip, the Financing Did](#the-financing-slipped) scheduled is about to start. The written commitment for the €600,000 bridge arrived on 20 September, three weeks after the date the board had set, and it carries a condition: the existing investors will fund the bridge only if, by 31 October, the board has adopted an operating plan under which Larkspur’s cash stays above the agreed €400,000 reserve until at least 30 June without any proceeds from the delayed round. The round itself is where it was in August, a conversation whose closing keeps moving. Alex, the CTO, and Priya, the product leader, have costed the deeper reduction the board asked for. Now the board has to decide it.
...
- **Reviews:** 1 December, on notices served, the bridge drawn, the transfer test and the second customer’s answer; 1 February, the first full month of saving reconciled against the table; 1 April, the round’s stage under the restart rule from [The Roadmap Did Not Slip, the Financing Did](#the-financing-slipped).
