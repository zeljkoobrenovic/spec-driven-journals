...
- **2026-07-29 (follow-up):** Panel 7 image regenerated — now depicts the mid-quarter green/yellow/red scoring board plus the documented-changes log, closing the spec-criterion gap; caption and alt updated.
