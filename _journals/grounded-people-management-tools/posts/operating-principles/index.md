...
- **Three sections, not one list.** How we work covers method — the behaviors that get things done. Who we are covers character — the disposition I want in every hire regardless of role. And leaders is a separate, harder section: leaders are held to demands the rest of the organization is not.
...
- **Keep a secondary layer of slogans, lightly.** Alongside the numbered principles, a short list of memorable one-line slogans — the "classic" phrases that predate or outlive any particular version of the formal set — can carry cultural memory without the same rigor as the named principles.
...
**A slogan layer is memory, not a substitute.** The named principles carry the weight — they are what gets tested against a real decision — but a handful of one-line slogans, held lightly and without their own bodies, can outlast a particular version of the formal set and give people something short to repeat in the hallway. The moment a slogan starts standing in for a principle nobody bothered to write down properly, the layer has swapped places with the substance it was meant to support.

## What This Means in Practice

| What this record says | What it does **not** say |
| --- | --- |
| Culture is written down in three named sections: how we work, who we are, and leaders (named "And leaders" in the source workbook). | One undifferentiated list of values covers the same ground — method, character, and leadership expectations are different questions. |
...
| And leaders get a separate, harder section of demands. | Leadership expectations are folded into the general list — leaders answer to a distinct, sharper bar. |
