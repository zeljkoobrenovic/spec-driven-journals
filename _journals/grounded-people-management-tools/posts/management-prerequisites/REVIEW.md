...
- **2026-07-29 (follow-up):** Panel 6 image regenerated — the scorecard now sits against a cadence-free calendar, so the results-and-how beat is no longer tied to the wrong cadence.
