---
title: Test Revenue Assumptions: Do Customers Respond as Expected?
date: 2026-09-12
...
timetoread: 24 min read
logo: "assets/images/10-roadmap-to-revenue/logo.jpeg"
logo_credit: "Image generated by Google Gemini (gemini-3-pro-image-preview)"
icon: "assets/icons/10-roadmap-to-revenue.png"
---
...
This is a **separate, smaller pilot example**. A **pilot** is a limited trial run before a wider commitment. We are testing the benefit of one reusable setup step, not costing the €1 million onboarding program in the chapter [[obligations-before-budget]].
...
![Released staff time can support more customers, other product work or avoided future spending while current payroll continues.](assets/images/10-roadmap-to-revenue/freed-time-conversion-plan.jpeg)
...
![An observed onboarding improvement is checked against the product change, customer mix and other initiatives using comparable groups.](assets/images/10-roadmap-to-revenue/check-what-explains-the-result.jpeg)
...
The same pilot is the funded first-hundred-days commitment ONB-1 in the chapter [[first-hundred-days]]. Priya measured the first cohort at day 90; the board decided at its day-100 review. All figures are fictional.
