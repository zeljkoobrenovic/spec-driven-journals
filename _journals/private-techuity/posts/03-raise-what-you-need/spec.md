...
# Spec: Raise the Money You Need, Not the Most You Can

## Intent

Compare ownership arrangements using the company’s actual work and uncertainty. Separate investor type, control, financing and transaction context; a carve-out and a turnaround are not categories of investor.
...
- Use distinct fictional situations once, then explain when changes in demand, funding or timing require the ownership and financing fit to be reassessed.
