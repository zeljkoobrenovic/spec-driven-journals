...
# Spec: Four Companies That Actually Existed

## Intent

Frame the cases as tests of the preceding argument, state that they are chosen for contrast rather than as a representative sample, and preview the verdict chapter.

## Audience

A reader arriving at Part VI in sequence, plus one dipping in from the contents page who needs to know whether this part is the one they want.
