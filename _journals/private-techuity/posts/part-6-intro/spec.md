...
# Spec: Lessons from the Field

## Intent

Give the historical cases distinct teaching jobs and a common set of questions about expectations, decisions, resources, outcomes and evidence limits.
