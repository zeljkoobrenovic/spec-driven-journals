...
4. **Keep the conditions that make a decision permissible and feasible.** The organization chapter's future hiring trigger drops the financing condition. The acquisition example's two-month network overlap conflicts with an all-parent-services-off May test. The finale treats a service cutoff that exceeds existing customer contracts as an ordinary acceptable alternative. Establish the funding gate, a feasible transition calendar and contractual consent or a compliant alternative before presenting the trade-offs. [Organization](22-fix-decisions-before-hiring/REVIEW.md), [acquisition](26-acquisition-adds-work-first/REVIEW.md), [finale](30-success-for-whom/REVIEW.md).
...
| [Part III introduction](part-4-intro/REVIEW.md) | Low | Preserve improved grouping; widen support handoff |
| [Cannot Fund Everything](17-cannot-fund-everything/REVIEW.md) | High | Reconcile the recovery retest with the shared resource record |
| [Roadmap to Revenue](18-roadmap-to-revenue/REVIEW.md) | High | Keep observed capacity separate from cash and future benefits |
| [Team Delivery](20-can-the-team-deliver/REVIEW.md) | Medium | Respect lead-time boundaries; complete comic alignment |
| [Fix Decisions Before Hiring](22-fix-decisions-before-hiring/REVIEW.md) | High | Preserve the funding gate; correct the work trace |
| [Growth Into Design](25-growth-into-design/REVIEW.md) | Medium | Include recurring supplier and fallback costs |
| [Cheaper Cloud Bill](29-cheaper-cloud-bill/REVIEW.md) | Medium | Separate improved unit cost from missing the spending plan |
| [Prove You Can Restore](28-prove-you-can-restore/REVIEW.md) | High | Fund the retest and define accepted recovery scope |
| [AI Strategy](19-ai-strategy-three-questions/REVIEW.md) | Medium | Reconcile throughput, recurring costs and decision gates |
| [Acquisition Adds Work](26-acquisition-adds-work-first/REVIEW.md) | High | Make dual-running and independence milestones compatible |
| [Part IV introduction](part-3-intro/REVIEW.md) | Low | Preserve distinct jobs and continuing-service allowance |
| [Investor's Adviser](18-investors-adviser/REVIEW.md) | High | Qualify assessment authority and formal oversight |
| [Find the Help](11-help-that-changes-capability/REVIEW.md) | Medium | One support calendar and comparable capped costs |
| [Useful Engagement](12-useful-engagement/REVIEW.md) | Medium | Align pilot and engagement dates, costs and handover |
| [Part V introduction](part-7-intro/REVIEW.md) | Medium | Correct the claim of one finding through all four chapters |
...
| [Part VI introduction](part-8-intro/REVIEW.md) | Medium | Match case windows to the expanded evidence |
