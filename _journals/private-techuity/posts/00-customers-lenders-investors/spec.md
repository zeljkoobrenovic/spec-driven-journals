...
Explain the funding behind a company leader’s commitments. Introduce investor ownership across private funding arrangements, with public markets and founder funding as comparisons; distinguish new company cash from payments to existing owners.
...
- Locate venture, growth, buyout and corporate ownership within the funding landscape without assuming control changes or borrowing in every investment.
- Connect the source of money to the company’s obligations, then lead into different organizations that can own and fund a company.

## Non-goals

Detailed investor-fit comparisons belong in [[raise-what-you-need]]. Keep this first chapter focused on cash sources, basic ownership and the obligations accompanying each source. Leave valuation and returns to their dedicated chapters.
