...
| The investor wants better reporting, or we keep arguing about what a number means | [[have-your-numbers-ready]] | the [[toolkit]] measure record, then [[roadmap-to-revenue]] for the benefit arithmetic |
| The investor wants to oversee technology across all the companies it has invested in (its portfolio) | [[grounded-architecture-portfolio]] | [[operating-model-blueprints]], [[have-your-numbers-ready]] |
...
5. the pilot’s measured outcome and the decision it supports, [[roadmap-to-revenue]], and how those numbers are defined, owned and labelled, [[have-your-numbers-ready]];
