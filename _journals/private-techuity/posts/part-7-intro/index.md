...
excerpt: "Lead when the company’s money or owners change: check the business before an investment, fund the first plan, and hand over the evidence and unfinished promises."
permalink: part-7
timetoread: 2 min read
logo: "assets/images/part-7-intro/logo.jpeg"
logo_credit: "Image generated by Google Gemini (gemini-3-pro-image-preview)"
icon: "assets/icons/part-7-intro.png"
---
...
**Figure 1:** *Three chapters follow the onboarding finding from diligence to handover.* [Open diagram at full size](assets/images/part-7-intro/chapter-overview.jpeg)
