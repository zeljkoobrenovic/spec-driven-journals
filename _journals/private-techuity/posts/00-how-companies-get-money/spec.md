...
Detailed investor-fit comparisons belong in [[investment-fit]]. Keep this first chapter focused on cash sources, basic ownership and the obligations accompanying each source. Leave valuation and returns to their dedicated chapters.
...
- **2026-09-12: Added as a new Chapter 1** rather than a section inside [[capital-and-ownership]]. The author judged that private equity was arriving out of the blue and wanted the broader financing picture, including public markets, treated in its own right. All subsequent chapters renumbered; every permalink unchanged.
