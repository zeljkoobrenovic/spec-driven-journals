...
- **ONB-1.** Cohort of eight customers, measured by Priya at day 90 against the day-20 baseline. Effort fell from 80 to 62 hours per implementation, not the 50 the teaching model in [[roadmap-to-revenue]] assumed. About 40% of the remaining hours traced to customer data quality, so Alex’s explanation was partly supported and Morgan’s structural explanation was not wrong either. Customer waiting time was unchanged, which the separate measurement made visible; errors and support tickets did not rise. The observed reduction is 8 × 18 = 144 hours; any annual figure built on it is a projection, and [[roadmap-to-revenue]] shows how far it can be carried. On cash, ONB-1 had incurred about €90,000 of its €180,000 by day 100 and used about ten of its twelve engineer-weeks; the remaining €90,000 is payable over the next two quarters for the less-common customer-type templates, and the €30,000 a year of maintenance starts in the next financial year from the operating budget.
