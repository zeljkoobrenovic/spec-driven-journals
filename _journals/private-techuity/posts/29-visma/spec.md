...
- Keep the opening callouts brief and non-repetitive, make the opening key points readable before the acronyms are introduced, place the concrete leader’s decision before the definitions block, keep explanatory paragraphs to one job each (roughly under 150 words), split the budget example into the decision, the information it needs and its accountable owner, and present the closing check as three numbered items. Hold the summary within 300–500 words by the collection’s counting rule.
