...
## The Empirical Record Resists a Single Verdict

Davis and colleagues' April 2024 revision studies US buyouts from 1980–2013 and finds substantial variation by transaction type and economic conditions. Its reported two-year employment effects are approximately −12% for public-to-private buyouts and +15% for private-to-private buyouts, relative to controls. These are estimated average differences for studied groups, not predictions for an individual company. [S08: Davis et al., 2024 revision](https://www.nber.org/system/files/working_papers/w26371/w26371.pdf)
...
These studies are observational. Matching, controls, and research design improve inference, but target selection, measurement, and external validity still matter. Historical averages should inform questions and scenarios rather than become forecasts for a present-day software portfolio.

## Some Harms Require Direct Attention

Healthcare evidence demonstrates why company earnings and investor outcomes cannot stand in for stakeholder welfare. Gupta and colleagues' August 2023 revision studies US nursing homes and reports an adverse mortality effect for a subset of patients under its instrumental-variable design, alongside evidence involving staffing and care. The interpretation depends on the studied population and identification assumptions; it is not an estimate for every care setting. [S11: Gupta et al., nursing homes](https://www.nber.org/system/files/working_papers/w28474/w28474.pdf)

Kannan, Bruch, and Song's 2023 hospital study compares 51 PE-acquired hospitals with 259 controls. It reports an adjusted increase of 4.6 hospital-acquired conditions per 10,000 eligible hospitalizations, equivalent to 25.4% of the pre-acquisition rate at the PE hospitals. The relative percentage is not a percentage-point increase in every patient's risk. [S12: Kannan et al., adverse events](https://jamanetwork.com/journals/jama/fullarticle/2813379)

An earlier study by Bruch, Gondi, and Song found increases in financial measures and improvements in some measured quality indicators, with differences between HCA and other hospitals. [S39: Bruch et al., hospital measures](https://jamanetwork.com/journals/jamainternalmedicine/fullarticle/2769549) These findings do not simply cancel one another. They examine different outcomes and samples. Improvement in one quality measure cannot establish the absence of harm in another.
...
## What the Technology Principal Can Change

The Principal can improve the quality of the investment's technical assumptions, expose unfunded dependencies, help management resolve constraints, and preserve a record of outcomes. They can challenge an intervention whose apparent savings depend on weaker future performance. They can also help identify where additional investment has a credible path to value.

They cannot control the capital markets, remove every conflict, or guarantee that all stakeholders benefit. Their responsibility is to make the relevant evidence and consequences harder to ignore, and to act within an explicit mandate when decisions need support or escalation.
