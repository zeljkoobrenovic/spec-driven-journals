...
# Spec: The Same Ownership Period, Seen From the Other Chair

## Intent

Mark the perspective shift to the owner's side, define the Technology Principal briefly, and say which two kinds of reader want this part.

## Audience

A reader arriving at Part IV in sequence, plus one dipping in from the contents page who needs to know whether this part is the one they want.
