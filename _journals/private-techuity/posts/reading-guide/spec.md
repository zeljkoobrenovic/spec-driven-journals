...
# Spec: Private Techuity — Purpose and Reading Guide

## Intent

Position the book for product and technology leaders working under private equity ownership, with explicit wider applications. Explain the six-part journey, the ownership-cycle preview, optional Productscapes appendix and updated reading routes.
...
This reference page uses the Article modality. The 29 main chapters and two appendix essays additionally provide a TL;DR and a comic storyboard. Reference material is not padded with redundant adaptations.
