...
Only the first kind binds the company whatever anyone later decides, and only part of it is money owed, a **debt** in the ordinary sense; a promise to set up a customer is owed as work. The other three are decisions: approvals, accepted risks and possible future work. The record carries them as decisions with reasons so the receiving side can revisit them knowingly rather than discover them. The chapter [[acquisition-adds-work-first]] shows the same point from the buyer’s side: an acquisition adds the work of combining or separating the businesses before it adds anything else.
