---
title: "Find the Help That Changes What Your Team Can Do"
date: "2026-09-13"
...
logo: "assets/images/29-help-that-changes-capability/logo.jpeg"
logo_credit: "AI-generated illustration"
icon: "assets/icons/29-help-that-changes-capability.png"
---
...
> **WHY INVESTORS CARE:** Operating support is part of what investors sell to their own investors and to founders; it earns its cost only when it changes what the company can do, so the investor needs the request to be specific.
...
A sourcing chapter should contain a sourcing decision. The comparison below is fictional and uses the figures from the shared Larkspur chain; the categories are what to compare, not a claim about what any investor offers.

Priya, accountable for the onboarding pilot, and Alex, who must find the engineering time, compare four routes to the same result: one setup path made repeatable within the pilot’s first six weeks.

| Route | Availability | Company effort | Cost category | Relevant experience | Verdict |
| --- | --- | --- | --- | --- | --- |
| Peer conversation with a portfolio CTO who made setup repeatable | One hour within two weeks | Half a day of preparation | None beyond time | Similar problem, larger customers; context needs checking | Take it first, as a check on the approach |
| Investor’s specialist, introduced by Morgan | Ten days over six weeks, starting in three weeks | About six days of one engineer plus customer-team sessions | Specialist days charged to the company; funded from the ONB-1 budget | Has done this at two comparable companies; not with Larkspur’s customer data | Chosen first step |
| Independent specialist found by the company | Procurement and references add four to six weeks | Same engineering effort, plus selection time | Day rate, likely similar | Unknown until references are checked | Fallback if the investor’s specialist is unavailable or a poor fit |
| Permanent implementation specialist | Three to four months to start | Onboarding and management | About €150,000 a year recurring; the diligence response costed two such hires at €300,000 a year | Depends on the candidate | Deferred, pending pilot evidence |

**Chosen:** the investor’s specialist for a bounded six-week assignment alongside a Larkspur engineer, preceded by the peer conversation. **Rejected for now:** the independent specialist, because the added weeks would push the pilot past the day-90 review; the permanent hire, because the board deferred hiring until the pilot shows how much effort the setup step removes. **Funding:** the specialist days come from the ONB-1 budget committed in [[first-hundred-days]]; Sam confirms the amount fits the envelope. **Scarce capacity:** six engineer-days that Alex takes from portal research, which was already research-only. **Authorized by:** Priya, within the pilot’s approved budget; Alex commits the engineer; no new board decision is needed. **Evidence that would change it:** the specialist’s start slipping beyond week three, references showing experience only with much larger customers, or the peer conversation revealing that data intake, not the setup step, decided the outcome elsewhere.
...
Temporary help doesn’t always need to end in complete independence. A company may sensibly keep buying a scarce specialist service. It should understand the continuing cost, availability and responsibilities rather than discover the dependence when the first assignment finishes. The engagement review in [[useful-engagement]] is where that choice is made explicit.
...
Behind the sentence sit the decisions made above: the result (one repeatable path, tested on actual customer setups), the source (the investor’s specialist, with an independent specialist as fallback), the company effort (six engineer-days and two customer-team sessions), the funding (the ONB-1 budget) and the accountable leader (Priya). What the sentence leaves open, on purpose, is the specialist’s exact days, the information they may see, who directs their work and how the engagement ends. The next chapter negotiates those commitments: [[useful-engagement]].
...
- **[How Smart Is Smart Money? A Two-Sided Matching Model of Venture Capital](https://doi.org/10.1111/j.1540-6261.2007.01291.x)** — Morten Sørensen, The Journal of Finance, 2007.<br>*A matching model of venture investors and start-ups that attributes most of the advantage of experienced investors to selecting stronger companies, a caution against attributing a company’s results to its investor’s network.*
- **[Eleventh Annual Private Equity Leadership Survey](https://www.alixpartners.com/insights/private-equity-leadership-survey-2026/)** — AlixPartners, 2026.<br>*A consulting firm's survey that asks portfolio company executives the same questions as investors, one of the few sources showing where the two sides disagree about support.*
