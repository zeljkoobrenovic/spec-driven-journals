...
A founder might **roll over** some sale proceeds into the new ownership structure. A manager might buy shares with personal money. Another executive might receive options or a share-based incentive whose payout depends on earning the rights over time or meeting conditions, known as **vesting**, and on specified value thresholds. These arrangements can produce very different results even when all participants are described as having management equity.
...
In a fictional example, a manager is promised 5% of a pool that participates only in proceeds above a €100 million threshold. At €140 million of qualifying equity proceeds, 5% of the €40 million excess is €2 million. That is not 5% of €140 million. The real plan may calculate the pool differently; this example shows why the denominator, threshold, and payment order matter.
...
ILPA's principles address alignment through matters including the general partner’s own capital commitment, fee economics, carry and governance. They represent the perspective of investors in the fund, which is valuable but does not encompass every employee or customer interest. [S02: ILPA principles](https://ilpa.org/wp-content/uploads/2019/06/ILPA-Principles-3.0_2019.pdf) The product leader's task is to add the company and customer consequences to the discussion, not assume that a fund-level alignment mechanism covers them.
...
The proposed remedy is a small set of connected measures with explicit guardrails. Pair revenue growth with retention and contribution economics. Pair cost reduction with service quality and future delivery capacity. Pair technical progress with customer use. The measures do not remove judgment; they make a narrower range of misleading stories possible.
...
For the Technology Principal, this creates a personal tension. Credibility with investors may appear to depend on presenting confident value-creation claims. Credibility with company teams depends partly on acknowledging the constraints they experience. Sustainable credibility requires the same factual account in both rooms, with the level of detail adapted to each audience.
