...
- 2026-09-21 (Part IV order): Move the adviser chapter immediately before the technology operating partner chapter, in source folder `21-investors-adviser`. Update the opening recap and closing bridge; preserve its article, summary, comic and artwork.
