...
# Spec: Working With the Investor’s Technology Adviser

## Intent

Explain how a company leader can work with the investor’s adviser. Keep the supplied Technology Principal role explicitly fund-specific and compare it with venture support, corporate specialists and an investor with no operating team.
