---
title: "Build the Evidence Everyone Trusts: Data Foundations for Alignment"
date: 2026-09-22
...
logo: "assets/images/08a-data-foundations-for-alignment/logo.jpeg"
...
![Four identical cards distinguished only by hanging tags reading Actual, Target, Forecast and Assumption; only the Actual card is anchored to something below it.](assets/images/08a-data-foundations-for-alignment/four-kinds-of-number.jpeg)
...
![Dense working records inside the company pass through an open gate and are aggregated into a single shared sheet, which carries a tag reading With its definition.](assets/images/08a-data-foundations-for-alignment/internal-and-shared.jpeg)
...
Part II has established who decides, what each party stands to gain or lose, how the relationship behaves under pressure, and now the evidence all three depend on. Part III turns to what this evidence is for: choosing among things the company cannot all afford, and committing only to what it can deliver — [[part-3]] and [[cannot-fund-everything]].
