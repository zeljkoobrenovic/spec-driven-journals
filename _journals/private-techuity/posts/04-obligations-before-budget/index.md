...
[[valuation-is-an-estimate]] distinguished earnings from cash in principle. This chapter works from earnings to the cash remaining after planned payments, then examines runway in a company spending more than it collects. Both calculations help turn an investment request into a choice about timing and competing obligations.
...
Part I has now followed the money from funding to company cash. Part II asks who can decide how that cash and the company’s people are used. Begin with [[part-2]], then [[decide-who-decides]].
...
- **[Default Alive or Default Dead?](https://paulgraham.com/aord.html)** — Paul Graham, October 2015.<br>*A short essay on whether a company reaches profitability on current spending and growth, which states the second Larkspur scenario as a founder's habit of mind.*
