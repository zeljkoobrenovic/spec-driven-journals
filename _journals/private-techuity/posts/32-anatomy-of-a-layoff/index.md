...
Three of the eight leave the payroll on 30 November, three on 31 December and two, the second-country engineers, who are on three months’ notice, on 31 January. The saving therefore ramps: about €20,000 in December, about €45,000 in January and the full €72,000 from February. The one-off costs run the other way: about €95,000 of severance, €15,000 of outplacement and legal cost and about €10,000 of accrued leave, €120,000 in all, paid with the final salaries between November and January. Sam’s cash table, with the bridge drawn on 15 November, reads:
...
<!-- illustration-placeholder
{
  ...
  "visual_goal": "Show that at this company's notice periods and severance the reduction's savings arrive after its one-off costs, so at these dates it extends money that arrives but cannot replace money that is late: three simple cash lines against a reserve line.",
  ...
  "caption": "At Larkspur’s notice periods and severance the reduction’s savings arrive after its costs: it makes the bridge last longer and cannot stand in for it. Compare costs, savings and funding by date before assuming either result."
}
-->

Cash on 30 June is €505,000, above the reserve with a margin of about one month, and the reserve is reached in the second week of August. That meets the condition. The plan also holds one funded contingency of up to €17,000, described under knowledge transfer below; used in full, it leaves €488,000 on 30 June and brings the reserve date forward to the first week of August, still inside the condition. Without R2 the same table shows €200,000 on 30 June and the reserve breached in mid-May, which is why the investors attached the condition. The third comparison is the one a board rarely asks for. Without the bridge, R2 or no R2, Larkspur is below the reserve in January: the one-off costs come first, and the first full month of saving is February. R2 with no bridge reaches the reserve about ten days earlier than R1 alone would have. At Larkspur’s notice periods, severance terms and dates, **the reduction makes the bridge last longer and cannot stand in for it**, because its costs land in November, December and January and its first full month of saving is February, after the reserve date. That is a result of these figures, not a rule: shorter notice, lower severance, an earlier decision or a later reserve date would change the answer, which is why transition costs, savings and funding have to be compared by date rather than assumed either way. Sam puts the dated comparison at the top of the board paper, and on these figures it is the reason R3 is not the fallback if the bridge fails.
...
- **Funding:** €120,000 of one-off cost from operating cash inside the adopted plan; the savings as tabled; a contingency of up to €17,000 for the fixed-term extension below, held in the plan and spent only if triggered; the bridge drawn on 15 November once the plan is adopted.
...
- **Reviews:** 1 December, on notices served, the bridge drawn, the first transfer test and where both second-country customers stand; 15 January, the transfer retest and whether the extension is triggered; 1 February, the first full month of saving reconciled against the table; 1 April, the round’s stage under the restart rule from [[the-financing-slipped]] and, if the extension ran, whether the transfer passed.
- **Evidence that would change the decision:** a signed subscription agreement for the round that the board authorizes counting does not reverse R2, because the notices will have been served and the people will have left; it stops any further reduction and reopens the mobile app only as a new proposal with its own case. The bridge failing its own conditions does not trigger R3; it puts a different question to the board, whether Larkspur can be financed by someone else or sold on the terms available, which [[handover-of-obligations]] takes up. The second customer terminating narrows the remaining engineer’s work to one customer and removes that customer from Sam’s forecast. The transfer retest failing on 15 January triggers the extension; the extension ending on 31 March without a passed transfer sends the second-country scope back to the 1 April review, with the first customer’s September date the first thing reviewed. Incidents rising for two consecutive months after the on-call change cut the customer-committed change list before anyone is hired.
...
**Customer commitments revised.** The two second-country contracts promised go-live in the first quarter and allow the customer to terminate if it slips past 30 June. With one engineer instead of three, the country’s tax and pricing rules land at the end of May and one customer’s configuration a month after that, so both cannot be live in the first quarter, and Priya settles that with the customers before the notices are served, so that no customer learns of the change from a departing engineer. The first customer, whose own rollout is not ready before the autumn, accepts a September go-live with three months’ subscription waived, about €9,000 that was never in the collected revenue because the customer is not yet live. The second customer does not agree to any date beyond its contract, so the plan does not ask it to: its configuration is sequenced first, for go-live by 30 June inside the contractual date, and the first customer follows in September. That sequencing is what the funded contingency below protects. The second customer’s termination right stays in the record as a remaining risk, no revenue is counted from either customer until go-live, and the December review records where both stand.

**Knowledge transferred while the specialists are still employed, with a funded fallback.** The two departing second-country engineers hold the mapping between the country’s tax rules and Larkspur’s configuration. They are the two on three months’ notice, employed until 31 January, and the transfer test from [[fix-decisions-before-hiring]] runs while they are: in the second week of December the remaining engineer releases one rule change alone and the written mapping is reviewed against the release; if that fails, the retest is on 15 January. The plan also funds what happens if the retest fails. One of the two, by an agreement recorded before the notices are served, is offered a fixed-term extension of up to two months from 1 February at the same monthly cost, about €8,500: a contingency of up to €17,000 that Sam holds in the plan and spends only if triggered. The extension serves both risks at once. It completes the transfer, and if the transfer still cannot be completed it delivers the second customer’s configuration by 30 June with the mapping still in the building. If the engineer declines, the same contingency buys contractor time under the remaining engineer’s direction for that configuration alone, and the transfer rests on the written mapping and the retest. The extension ends on 31 March whatever the result; if the transfer has not passed by then, the second-country scope is re-planned at the 1 April review. Used in full, the contingency leaves €488,000 on 30 June instead of €505,000. The mobile app needs no transfer, because nobody is going to change it; it needs the state-of-work record.
...
**The employment process belongs to a jurisdiction, and the thresholds decide the calendar.** Two statutes show how differently the thresholds can be drawn; neither is asserted to govern Larkspur. The European Union directive on collective redundancies defines them as dismissals for reasons not related to the individual workers concerned. It applies, at each member state’s choice, either over thirty days, from at least ten dismissals in an establishment normally employing more than twenty and fewer than a hundred workers, at least ten per cent in one employing at least a hundred and fewer than three hundred, and at least thirty in one employing three hundred or more, or over ninety days, from at least twenty dismissals whatever the establishment’s size; other terminations on the employer’s initiative for reasons unrelated to the individual count toward those numbers once there are at least five redundancies. An employer within it has two separate duties: to consult the workers’ representatives in good time with a view to reaching an agreement, on ways of avoiding or reducing the redundancies and mitigating their consequences, and to notify the competent public authority in writing, after which the redundancies take effect not earlier than thirty days later, without prejudice to individual notice rights. Member states may be more favourable to workers, and the directive sets a floor, not the rule in any particular country. [S77: Council Directive 98/59/EC](https://www.legislation.gov.uk/eudr/1998/59) In the United States, the federal statute covers employers with a hundred or more employees excluding part-time employees, or a hundred or more whose hours in aggregate reach four thousand a week. It defines a plant closing by fifty or more employment losses at a single site within any thirty-day period, and a mass layoff by losses at a single site within any thirty-day period for at least a third of the employees and at least fifty of them, or for at least five hundred, in each case excluding part-time employees; smaller groups of losses within any ninety-day period are aggregated unless they have separate and distinct causes. It requires sixty days’ written notice to the employees’ representatives or the employees themselves, to the state’s dislocated-worker unit and to the local government, with reduced notice only in the stated exceptions, and state law can add notice rules of its own. [S78: US WARN Act, 29 U.S.C. §§ 2101–2102](https://www.law.cornell.edu/uscode/text/29/2101) Eight dismissals in an establishment of forty sit below the directive’s thirty-day band for that size and below its ninety-day alternative, and forty employees sit below the federal statute’s employer threshold, but a national law may set lower thresholds, individual dismissal law and works-council rules apply in any case, and this book does not say which law governs Larkspur. Larkspur’s notice periods and severance formula above are its fictional contract terms, not a statutory minimum anywhere. What the chapter does say is that the calendar in the cash table assumes individual notice with no collective procedure, that Larkspur’s counsel confirms the assumption before the date is fixed, and that if the assumption is wrong every date moves by at least the consultation and notification periods. A reduction planned without that check has a saving date nobody can rely on.
