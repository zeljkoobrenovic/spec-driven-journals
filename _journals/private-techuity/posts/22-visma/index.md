...
> **WHY INVESTORS CARE:** The funds behind a holding change while the manager stays; each new investor buys at a new price and needs the earnings measure it is paying for to be the same one management budgets on.


> **KEY POINTS:**
>
> * The same investment firm can remain involved while **the funds and investors behind it change**. Hg’s own announcements name two different funds and one investor’s complete exit; a long relationship is not one unchanged investment.
...
<br>
Visma is a group of business-software companies. Its public accounts describe product development, acquisitions and shared support alongside changes in its investors. The case shows a different pattern from the completed exits in the previous chapter: no exit, but repeated changes of money behind a familiar name.
...
This chapter is the book’s home for that lesson. [[teamsystem]] returns to it only briefly, from the different angle of a later owner inheriting accumulated acquisition work and a partial reporting period.
