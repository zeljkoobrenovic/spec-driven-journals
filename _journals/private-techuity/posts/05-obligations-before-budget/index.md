...
**Scenario note.** The pilot’s cost basis and decision rules are shared with the chapter [[raise-what-you-need]] and the day-100 ledger of Part V, and the onboarding constraint is supported by customer evidence, as in the chapter [[roadmap-to-revenue]]. The maintenance timing deliberately differs: those chapters place the first year of maintenance in the financial year after the step ships; here the charge starts the month the step enters service.
...
Pricing three options is what turns “we can’t afford €1 million” into a decision someone can take. The chapter [[cannot-fund-everything]] extends the method to several projects competing for the same cash and the same engineer-weeks.
