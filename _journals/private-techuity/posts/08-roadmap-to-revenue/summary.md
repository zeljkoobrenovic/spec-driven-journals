...
Identify the value mechanism precisely. More sales, customers staying, a higher share of revenue left as profit, earlier payment, reduced risk and new strategic choices need different evidence. Avoid adding overlapping benefits: earlier collection is not automatically additional lifetime revenue, and a retained customer may already be included in the forecast.

Product strategy determines where efficiency matters. Begin with the customers and needs the company intends to serve. Apply the same customer and economic test to requests from sales, executives, investors, and acquisitions. User focus and stable priorities are relevant research themes, but they do not calculate a company's roadmap value. [S15: DORA 2024 report](https://dora.dev/research/2024/dora-report/)

Establish a **baseline**, a starting measurement with clear customers, dates, sources and costs. Compare similar customer groups, or introduce a change in stages, where feasible. Document competing explanations such as pricing, sales incentives, acquisitions, and customer mix. Finance can reconcile calculations and double counting; it cannot supply missing evidence of what would have happened without the change.
