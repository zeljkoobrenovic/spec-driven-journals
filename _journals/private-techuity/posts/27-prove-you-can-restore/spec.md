...
- 2026-09-24 (order, later the same day): Now the second chapter of Part VI, after [[manage-technical-debt]]; hand-offs unchanged. Folder to be renumbered `27-prove-you-can-restore`.
- 2026-09-24 (order): Now opens Part VI; closing hand-off points to [[cheaper-cloud-bill]] then [[ai-worth-its-cost]]. Folder renumbered to `27-prove-you-can-restore`; permalink and id unchanged.
- 2026-09-24 (part order): Moved to the new Part VI (SUSTAIN) as its closing chapter; closing hand-off now cites the AI chapter in Part IV and hands off to Part VII. Folder renumbered to `27-prove-you-can-restore`; permalink and id unchanged.
