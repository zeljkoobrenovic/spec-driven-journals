...
Agree specialist fees and implementation funding separately where they differ. “The specialist is included” doesn’t establish who pays for a supplier, new software or the company’s additional work. Larkspur’s charter charges the days to the company so the cost is visible against the pilot budget and comparable with the **fallback** — the alternative route the company would use if the preferred one failed, here an independent specialist hired on the open market. The costs are the fictional caps from the sourcing comparison in the chapter [[help-that-changes-capability]], repeated here so the charter can be checked against the choice:
