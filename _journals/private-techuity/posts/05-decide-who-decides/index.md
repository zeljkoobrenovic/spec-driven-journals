...
logo: "assets/images/05-decide-who-decides/logo.jpeg"
logo_credit: "AI-generated illustration"
icon: "assets/icons/05-decide-who-decides.png"
---
...
This is the €1 million program discussed in [[obligations-before-budget]], not an approved commitment to spend it. The board still needs a feasible funding plan.
...
Authority explains who can decide. The next chapter examines **incentives**, the rewards and consequences that influence what people choose: [[different-bets]].
...
- **[The Wates Corporate Governance Principles for Large Private Companies](https://www.frc.org.uk/library/standards-codes-policy/corporate-governance/the-wates-corporate-governance-principles-for-large-private-companies/)** — Financial Reporting Council (UK), December 2018.<br>*Six principles for private company boards, a reference for what a board is expected to do beyond what its owner asks of it.*
- **[Unlock value with PE portfolio company governance](https://www.deloitte.com/us/en/programs/center-for-board-effectiveness/articles/private-equity-portfolio-company-board-governance.html)** — Deloitte Center for Board Effectiveness, January 2026.<br>*Advisory guidance for the sponsor-appointed board this chapter's tables assume, covering composition, the split of board and management responsibilities, and dashboard reporting.*
