...
For a shorter first pass, read chapters **1, 2, 3, 4, 6, 7, 10, 18, 23 and 28** in the numbered contents below — financing, ownership, valuation, returns, cash, governance, product value, the Principal's role, support as a product and durable outcomes. A product leader can continue with 10–13 and 16–18. A CTO entering a new ownership arrangement can prioritize 6–9 and 19–22. A developing Technology Principal should connect the foundations with Parts IV–V, then use the cases to challenge the proposed methods.

If financial terms are unfamiliar, start at the beginning: [[pt-how-companies-get-money]] explains how companies are financed at all, and [[pt-valuation-and-architecture]] introduces revenue, EBITDA, cash and value before any return calculations. The glossary supports recall; it is not a prerequisite. Each article opens with Key points and briefly introduces the financial concepts it needs.
...
- **4.** [[pt-return-mechanics]]
- **5.** [[pt-investment-fit]]
- **6.** [[pt-cash-and-constraints]]
...
- **13.** [[pt-cloud-economics]]
- **14.** [[pt-security-and-resilience]]
- **15.** [[pt-data-and-ai]]
- **16.** [[pt-people-and-operating-models]]
- **17.** [[pt-acquisitions-and-carveouts]]
