...
"""Render Figure 1 of 26-anatomy-of-a-layoff as a chart plotted from the cash model.
...
def main() -> int:
    ...
    if out == ASSET and ASSET.exists():
        ...
        (ARCHIVE / f'26-anatomy-of-a-layoff-cash-by-date-{hashlib.sha256(previous).hexdigest()[:12]}.jpeg').write_bytes(previous)
