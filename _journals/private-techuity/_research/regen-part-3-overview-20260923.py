#!/usr/bin/env python3
"""One-off driver: regenerate the Part III chapter overview (Figure 1 of part-3-intro).
...
POST = ROOT / "_journals/private-techuity/posts/part-3-intro"
...
TARGETS = [
    {
        "id": "chapter-overview",
        "status": "pending",
        "asset": "assets/images/part-3-intro/chapter-overview.jpeg",
        "aspect_ratio": "4:3",
        "prompt": STYLE + LAYOUT,
        "layout": LAYOUT,
        "alt": ALT,
