#!/usr/bin/env python3
"""Regenerate two figures of 36-toys-r-us (archived under the legacy key 28-toys-r-us).
...
def accept(fid: str, note: str) -> None:
    ...
    (fig['discard_dir'] / f"36-toys-r-us-{fid}-{hashlib.sha256(previous).hexdigest()[:12]}.jpeg").write_bytes(previous)
