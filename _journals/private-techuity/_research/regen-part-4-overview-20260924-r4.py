...
LAYOUT = (
    "Heading: \"COMMIT\".\n"
    "Exactly SIX chapter cards organized into FOUR clearly separated horizontal bands, stacked "
    ...
    "This card carries a small simple line-drawn symbol of two small pyramids side by side, "
    "joined by a short horizontal line between them, in the same navy ink as the outlines, "
    "placed so it does not crowd the text. No other card in this band; leave the space either "
    "side of the single card empty.\n\n"
    ...
    "the evidence\".\n"
    "Only the listed six chapter cards; no extra or duplicated card; the AI key line is the only "
...
ALT = (
    "Six chapters in four moves under the heading COMMIT. First, agree what the work is for: adopt "
    "outcome thinking, pairing one customer outcome with one business outcome and the investor "
    "metric it feeds. Second, choose and justify the work: set priorities to fit cash and team time, "
    ...
    "from data): sell it, use it, or be replaced by it. Second, assess what delivery requires: find "
    "what the software and the team can support and what a transition would cost. Third, revise "
