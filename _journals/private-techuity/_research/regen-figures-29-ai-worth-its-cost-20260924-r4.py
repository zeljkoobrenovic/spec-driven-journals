...
"""Round-4 media driver for 29-ai-worth-its-cost (in-depth review, 24 September 2026).
...
AIC-020 (Figure 3): rendered by render-figures-29-ai-worth-its-cost-20260924.py with dark
...
RENDERER = J / '_research/render-figures-29-ai-worth-its-cost-20260924.py'
...
TARGETS = {
    'page4': dict(
        ...
        base=J / '_research/discarded-comic-variants/29-ai-worth-its-cost-comic-page-04-a-return-with-a-period-06dc669aba1f.jpeg',
