...
- **Build:** `python3 _wiring/build.py` → `[built] private-techuity`; `docs/private-techuity` now has 87 files (was 85): `headcount-plan-shrinks.html` and `.spec.html` added. No output changed outside `docs/private-techuity`.
