...
**Comic.** Larkspur is a fictional company that sells scheduling software, and an investor owns a large stake in it. That investor expects fast growth, and the expectation has reached the technology team as a request to make the software “more flexible”, with the reasoning left behind. The panels show Larkspur working out what was actually being asked for, comparing three ways to do it against the same customer need, the same date and the same spending limit, and choosing one — with a cheaper standby plan ready if the chosen one fails.

What “more flexible” turned out to mean: Larkspur must be able to bill, contract with and support customers in a **second country**, under that country’s tax and pricing rules, with the first customers actually **paying within twelve months** — and the investor’s plan expects a **third country within two years**, so each new country has to get cheaper to add than the last.

The people: Morgan advises the investor, Alex leads technology, Priya leads product, Sam leads finance, and Ines is the chief executive, who can approve spending inside the limit the board has set. All are fictional, and every amount and date below is invented for the example.

Two words recur. A **replay** means rerunning last year’s real invoices through newly written code and checking, line by line, that it produces the same bills — the test that catches mistakes before a customer is billed wrongly. A **specialist-week** means one week of work by one of the two people who can safely change the billing code; it measures effort, not how long the calendar takes.

<!-- comic-panel
{
  "id": "01-scene",
  "status": "generated",
  "asset": "assets/images/24-growth-into-design/comic-01-scene.jpeg",
  "aspect_ratio": "16:9",
...
![Comic panel: Alex and a colleague each hold up a large sheet in front of a single hanging price tag labelled “company valuation”. Alex’s sheet reads “Future A: growth assumption” — the belief that the company will expand. The other reads “Future B: efficiency assumption” — the belief that it will do the same work more cheaply. One price, two different futures behind it.](assets/images/24-growth-into-design/comic-01-scene.jpeg)
...
<!-- comic-panel
{
  "id": "02-scene",
  "status": "generated",
  "asset": "assets/images/24-growth-into-design/comic-02-scene.jpeg",
  "aspect_ratio": "16:9",
  ...
  "alt": "Comic panel: Morgan writes “valued on growth” on a whiteboard and adds three question marks beside it, watched by two colleagues. Faint earlier notes on the board read “market share” — the company’s portion of sales in its market — and “acquisition costs”, here meaning what it spends to win each new customer. Neither answers the question being asked.",
  "generation": {
    "model": "gemini-3-pro-image-preview",
    "reference_id": "owned-cast-20260913",
...
![Comic panel: Morgan writes “valued on growth” on a whiteboard and adds three question marks beside it, watched by two colleagues. Faint earlier notes on the board read “market share” — the company’s portion of sales in its market — and “acquisition costs”, here meaning what it spends to win each new customer. Neither answers the question being asked.](assets/images/24-growth-into-design/comic-02-scene.jpeg)
...
<!-- comic-panel
{
  "id": "03-scene",
  "status": "generated",
  "asset": "assets/images/24-growth-into-design/comic-03-scene.jpeg",
  "aspect_ratio": "16:9",
...
<!-- comic-panel
{
  ...
  "caption": "Modularity means dividing software into parts that each have a clear job. That can make selected changes easier on its own — it does not require splitting the software into many separately released and separately run services, which is a different decision with its own extra work.",
  "generation": {
    "model": "gemini-3-pro-image-preview",
    "reference_id": "owned-cast-20260913",
    "sha256": "8105775e68c4f560db46594061fc58cf3aa36eaea99a3c1dcf48b4d3e8d77938"
  }
}
-->

![Comic panel: Alex holds up one object in each hand. On the left, a single block visibly divided into four clearly separated coloured compartments, lettered “one piece, four parts”. On the right, four separate blocks of the same colours, neatly arranged in a row and joined by short connector lines, lettered “four separate pieces”. Both are drawn as equally tidy and deliberate.](assets/images/24-growth-into-design/comic-04-scene.jpeg)
...
<!-- comic-panel
{
  "id": "05-scene",
  "status": "generated",
  "asset": "assets/images/24-growth-into-design/comic-05-scene.jpeg",
  "aspect_ratio": "16:9",
  ...
  "caption": "A separate example, not part of the decision above: one proposed saving read four ways — its effect on profit, when the money actually moves, whether it helps win customers, and what it would take to build. Paying for it comes first; the saving arrives later, and the gap in between has to be funded.",
  "generation": {
    "model": "gemini-3-pro-image-preview",
    "reference_id": "owned-cast-20260913",
    "sha256": "55b31a8cc9cc353fce8983b8a900982cc41a02795a1815bcb1142c8f822c0b3b"
  }
}
-->

![Comic panel: Sam stands at a table with a stack of paper marked “proposal” and points to four cards fanned out in a row, headed “earnings”, “cash timing”, “customer growth” and “technical options”. The cash-timing card draws a small chart on a horizontal baseline: on the left one bar hanging below the line, labelled “pay first”; later, to its right, two shorter bars rising above the line under one shared label “save later”; an arrow along the baseline is labelled “time”. Money goes out before any comes back.](assets/images/24-growth-into-design/comic-05-scene.jpeg)
...
<!-- comic-panel
{
  "id": "06-scene",
  "status": "generated",
  "asset": "assets/images/24-growth-into-design/comic-06-scene.jpeg",
  "aspect_ratio": "16:9",
