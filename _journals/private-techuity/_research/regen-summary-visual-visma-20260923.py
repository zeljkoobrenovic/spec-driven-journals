#!/usr/bin/env python3
"""Regenerate the TL;DR overview figure of 29-visma (archive key and asset folder `27-visma`).
...
ASSET = J / 'posts/29-visma/assets/images/27-visma/summary-at-a-glance.jpeg'
...
def accept(note: str) -> None:
    ...
    (backups / f'29-visma-summary-at-a-glance-{hashlib.sha256(previous).hexdigest()[:12]}.jpeg').write_bytes(previous)
    ...
    for fig in archive['figures']:
        if fig.get('post') == ARCHIVE_KEY and fig.get('id') == 'summary-at-a-glance':
            ...
            fig['current_asset'] = 'posts/29-visma/assets/images/27-visma/summary-at-a-glance.jpeg'
            break
    else:
