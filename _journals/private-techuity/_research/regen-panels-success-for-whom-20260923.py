#!/usr/bin/env python3
"""Regenerate legacy comic panels of 38-success-for-whom (asset slug 30-success-for-whom).
...
POST = J / 'posts/38-success-for-whom'
...
def main() -> int:
    ...
    for panel_id in ids:
        ...
        (backups / f'38-success-for-whom-comic-{panel_id}-{hashlib.sha256(previous).hexdigest()[:12]}.jpeg').write_bytes(previous)
