#!/usr/bin/env python3
"""One-off driver: regenerate the three article figures of 29-ai-worth-its-cost.
...
POST = ROOT / "_journals/private-techuity/posts/29-ai-worth-its-cost"
...
TARGETS = [
    {
        ...
        "asset": "assets/images/29-ai-worth-its-cost/usage-construction-rates-bridge.jpeg",
        "aspect_ratio": "16:9",
        "prompt": FIG1,
    ...
    },
    {
        ...
        "asset": "assets/images/29-ai-worth-its-cost/three-numbers-never-added.jpeg",
        "aspect_ratio": "16:9",
        "prompt": FIG2,
    ...
    },
    {
        ...
        "asset": "assets/images/29-ai-worth-its-cost/commitment-floor-against-demand-range.jpeg",
        "aspect_ratio": "16:9",
        "prompt": FIG3,
...
def main() -> int:
    ...
    for item in TARGETS:
        ...
        if not args.out and out.exists():
            ...
            backup = ARCHIVE / f"29-ai-worth-its-cost-{item['id']}-{hashlib.sha256(old).hexdigest()[:12]}.jpeg"
