...
24 September 2026, round 2: the three application chapters ("Cloud costs",
"Resilience", "AI strategy") moved to the new Part V SUSTAIN, and the
funding-delay chapter ("The financing slipped" / manage funding delays) moved in
from LEAD. Part III now has FOUR chapters in three moves: 2 + 1 + 1. This driver
keeps the layout style, palette, 4:3 ratio, band arrows and ochre banner of the
earlier 24 September version (regen-part-4-overview-20260924.py), removes the
three application cards and the AI key line, and adds one "Manage funding delays"
card (small line-drawn calendar-with-hourglass icon) under the third band label
"Revise when the money is late", matching the updated alt text and Learning Path
bullets in posts/part-4-intro/index.md. The six-chapter render is archived under
discarded-illustration-variants/part-4-intro-chapter-overview-664cccc94a55.jpeg.
...
LAYOUT = (
    "Heading: \"COMMIT\".\n"
    "Exactly FOUR chapter cards organized into THREE clearly separated horizontal bands, stacked "
    ...
    "the evidence\".\n"
    "Only the listed four chapter cards; no extra or duplicated card and no key line or footnote. "
    "Do NOT include any card about cloud costs, resilience, artificial intelligence, hiring, roles, "
    "system changes, growth, acquisitions or separations. Do not number chapters."
)

ALT = (
    "Four chapters in three moves under the heading COMMIT. First, choose and justify the work: "
    ...
    "transition would cost. Third, revise when the money is late: put cash and commitments on a "
    "calendar and choose one fallback in time. All lead to one outcome: fund feasible work and "
    "review the evidence."
)
