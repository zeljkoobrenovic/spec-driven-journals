...
> **Status**: DRAFT
>
> **Principle**: A growing team changes the job whether I accept it or not — the only choice is whether I change with it. I move from the front-line view to the macro view: vision, org design, delegation, and communication become the work, and direct involvement becomes a tool I ration to where my attention matters most. Because authority makes truth expensive, I explicitly invite dissent and reward the people who bring me uncomfortable truths. I judge managers as multipliers — by outcomes, with the question "would I hire this person again for this role?" — and I apply the same test to myself: I keep looking for responsibilities someone else could own as well as I can or better, because putting myself out of the current job is how the next one gets created.
