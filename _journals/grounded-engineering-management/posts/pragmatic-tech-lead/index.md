...
timetoread: 7 min
excerpt: "What I hold tech leads to is project leadership from the engineer's side: clarify the role before exercising it, start projects with a real kickoff and written scope, break work into small shippable milestones with estimates treated as forecasts, respect the physics that bind scope, timeline, and people, mitigate risks and dependencies through prototypes and direct conversation, match the release process to the product's risk, keep stakeholders unsurprised — and close projects properly."
...
> **Status**: DRAFT
>
> **Principle**: A tech lead is not a junior manager and not a superior engineer — they are the person accountable for a project succeeding while remaining hands-on enough to understand the system and set its quality bar. I hold tech leads to project leadership from the engineer's side: clarify the role before exercising it; start projects with a real kickoff, a written scope, and aligned stakeholders; break work into small shippable milestones and treat estimates as forecasts, not commitments; respect the physics binding scope, timeline, and people — when one moves, something else must; mitigate risk through prototypes and engineer-to-engineer conversation rather than registers and escalations; match the release process to the product's actual risk, with safety nets; keep stakeholders informed so no one is surprised late; and close projects properly. Through all of it, the job is to make the team succeed — not to make the team dependent on the lead.
...
- Gergely Orosz, *The Software Engineer's Guidebook* (self-published, 2023) — the Pragmatic Tech Lead chapters (the role, project leadership, scope/timeline/people, day-to-day project management, risks and dependencies, shipping to production, stakeholders, team structure, and team dynamics) this record distills.
