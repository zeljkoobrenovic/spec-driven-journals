...
timetoread: 7 min
excerpt: "On a small team, management reduces to a handful of relationships, so trust is the foundation and everything else is built on it. I hold a weekly 1:1 with every report focused on their priorities and growth rather than status, I keep expectations and my read of their performance transparent, I diagnose problems as skill, motivation, or fit before acting, I spend disproportionate time on my strongest people, and when fit is genuinely wrong I move the person on promptly and with respect."
