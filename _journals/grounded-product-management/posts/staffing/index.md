...
- **Hire for competence and character.** I look for demonstrated competence, integrity, and coachability — and for people who think differently from the current team. I reject brilliant-but-toxic candidates, and I refuse to over-index on pedigree, domain experience, or vague "cultural fit."
- **Recruit continuously.** I build a network of candidates before openings exist — referrals, events, internal talent, long-term relationships — and I move fast when I find someone strong, with references I check myself.
- **Onboard intentionally.** The first 90 days are critical. I check in at deliberate milestones, run a real bootcamp beyond generic orientation, and build a coaching plan toward earned autonomy.
