...
icon: assets/icons/ieee-cs.png
author: by Željko Obrenović (obren.io)
permalink: jeff-tyree-and-art-akerman
timetoread: 15 min
excerpt: "The detailed ADR template from Jeff Tyree and Art Akerman's IEEE Software article 'Architecture Decisions: Demystifying Architecture' — captures Issue, Decision, Status, Group, Assumptions, Constraints, Positions, Argument, Implications, and related decisions for thorough decision rationale."
---
![](../assets/images/ieee-software-jeyy-tyree-art-akerman.png)
