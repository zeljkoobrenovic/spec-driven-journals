...
icon: assets/icons/arc42-logo.png
author: by Željko Obrenović (obren.io)
permalink: arc42
timetoread: 15 min
excerpt: "The arc42 architecture documentation skeleton — twelve canonical sections from Introduction & Goals through Constraints, Context, Solution Strategy, Building Blocks, Runtime/Deployment Views, Concepts, Decisions, Quality Requirements, Risks, and Glossary."
---

![](https://arc42.org/images/splash/unsplash-bridge-tom-van-hoogstraten.webp)
