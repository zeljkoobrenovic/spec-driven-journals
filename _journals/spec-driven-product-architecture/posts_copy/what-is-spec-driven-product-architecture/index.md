...
The project [Spec-Driven Product Architecture](https://github.com/zeljkoobrenovic/spec-driven-product-architecture) calls this approach **Spec-Driven Product Architecture**.
...
![Layered product-domain model showing customers, strategy, delivery, capabilities, product bricks, teams, roadmap, and evidence as connected source-of-truth layers.](assets/images/spec-driven-product-architecture-layer-model.png)
*Generated illustration: `spec-driven-product-architecture-layer-model.png`. A layered model diagram showing how product vision flows into customer groups, strategy horizons, capabilities, product bricks, delivery, teams, roadmap, and evidence.*
...
*Generated illustration: `dreaming-exploring-grounding-loop.png`. A three-part loop where Dreaming defines the intended product architecture, Exploring reads real source/code/cloud/log/finance data, and Grounding links concepts to evidence, assumptions, and trend signals.*
...
- [[evidence-validation-and-publishing]] covers evidence, validation, and generated static documentation.
