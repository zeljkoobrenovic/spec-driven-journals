...
![Generated product-domain overview page with a searchable grid of domains grouped into marketplaces, mobility, travel, finance, biotech, and technical infrastructure.](assets/extras/screenshot_product_architecture_index.png)
*The overview is more than a showcase. It gives agents and reviewers a starting map for comparing domains before choosing examples to inspect more deeply.*
...
![Side-by-side schematic comparison of a GitHub product-domain specification folder and the matching generated GitHub Pages documentation.](assets/images/domain-spec-to-generated-docs-comparison.png)
*The useful comparison is source next to publication: the Ride Sharing Marketplace folder shows the authored specification, while the generated pages show how that same model becomes navigable documentation.*
...
[[evidence-validation-and-publishing]] closes the series by returning to grounding: how evidence, validation, and static publishing keep the pattern library trustworthy enough to use.
