...
- **2026-05-22** - Kept visual-generation examples in the article but changed captions from internal filenames to public explanatory text.
...
- **2026-05-22** - Converted generated-image captions into reader-facing captions. Status `draft`. *(Spec-Driven Product Architecture, AI-mediated session)*
