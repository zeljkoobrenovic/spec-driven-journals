...
| `ai-conversations` | Session logs of AI-mediated authoring sessions against this repo, named by author + session and tagged by affected journals. | Per-session folder under `<author-id>/<session-id>/index.md` |
